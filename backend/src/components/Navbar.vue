<template>
    <header class="flex justify-between items-center p-4 h-16 shadow bg-white">
        <button @click="emit('toggle-sidebar')"
                class="flex items-center justify-center rounded transition-colors w-8 h-8 text-gray-700 hover:bg-black/10">
            <Bars3Icon class="w-6"/>
        </button>
        <Menu as="div" class="relative inline-block text-left">
            <MenuButton class="d-flex justify-between h-16 flex items-center">
                <img src="https://randomuser.me/api/portraits/lego/1.jpg" class="rounded-full w-8 mr-2">
                <small>Carter Choi</small>
                <ChevronDownIcon
...
<script setup>
import {Bars3Icon, BackwardIcon, UserIcon} from '@heroicons/vue/20/solid'
